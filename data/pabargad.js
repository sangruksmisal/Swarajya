/* Swarajya — Pabargad Fort data for offline use.
   Mirrors Forts/Pabargad/info.json wrapped as a JS variable.
   Loaded by <script> tag so the fort detail page works with file:// protocol. */

window.FORT_DATA = {
  "id": "pabargad",
  "name": { "en": "Pabargad Fort", "mr": "" },
  "alternate_names": ["Pabar Fort", "Pabargad"],
  "type": "hill",
  "altitude_m": 1100,
  "altitude_ft": 3609,
  ...
  "mountain_range": "Sahyadri (Western Ghats), Sangamner-Akole area",
  "unesco": false,
  "famous_for": "Minor hill fort in the Nashik district, part of the frontier chain of Maratha outposts along the northern Sahyadri passes",
  ...
  "nearest_railway": "Nashik Road Station (120 km)",
  "nearby_forts": [],
  ...
  "visitor_info": {
    ...
    "vehicle_access": {
      ...
      "note": "Accessible from Sangamner (~40 km) or Akole (~25 km) by road to the base village. Trek 2–3 hours one way. Local guide recommended."
    },
    "entry_timing": {
      "open": "06:00",
      "close": "17:00",
      "note": "No formal entry. Start early to allow sufficient return time before dark."
    },
    "prohibited_periods": [
      {
        "reason": "Monsoon — slippery trails and poor visibility",
        "months": ["June", "July", "August"],
        "advisory": "The Sahyadri trails become slippery in monsoon. Avoid June through August. October to February is ideal."
      }
    ],
    "risk_level": "moderate",
    "risk_notes": "Moderate trek with some exposed sections on the upper ridge. Carry water — the fort summit is dry. No facilities. Return before dark."
  },
  ...
  "emergency": {
    ...
    "nearest_medical": {
      "village": "Sangamner",
      "facility": "Rural Hospital, Sangamner",
      "distance_km": 40,
      "phone": null,
      "note": "Rural hospital at Sangamner. Pune (~130 km) for serious emergencies."
    }
  },

  "trek": {
    "grade": "Moderate",
    "base_village": "Base village near Sangamner/Akole (verify locally)",
  ...
  "gates": [
    {
      "name": "Fort Gate",
      "direction": "East",
      "description": "The primary approach entrance, partially ruined. Maratha-era stonework survives in sections."
    }
  ],
  ...
  "water_sources": [
    {
      ...
      "type": "Cistern",
      "description": "Monsoon-fed cisterns carved into the summit rock. Do not rely on these — carry your own water."
    }
  ],
  ...
  "temples": [
    {
      "name": "Devi Temple",
      "deity": "Local Devi",
      "description": "A small Devi shrine near the fort summit, worshipped by the local village community."
    }
  ],
  ...
  "timeline": [
    ...
    {
      "year": "Maratha period",
      "event_en": "The fort forms part of the Maratha network of hill forts across the northern Sahyadri, providing a watch and garrison point in the Sangamner-Akole corridor."
    },
    {
      "year": "1818",
